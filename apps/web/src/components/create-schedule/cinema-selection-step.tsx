							...
							<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
								{cityCinemas.map((cinema) => (
									<button
										...
										className="group hover:-translate-y-1 relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-6 text-left transition-all hover:border-primary/50 hover:bg-white/10 hover:shadow-lg hover:shadow-primary/5"
									>
										...
										<div className="relative z-10 flex items-start justify-between gap-4">
											<div>
												<h4 className="mb-1 font-bold text-lg text-white transition-colors group-hover:text-primary">
													{cinema.name}
												</h4>
											</div>
											<div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/5 transition-colors group-hover:bg-primary/20 group-hover:text-primary">
